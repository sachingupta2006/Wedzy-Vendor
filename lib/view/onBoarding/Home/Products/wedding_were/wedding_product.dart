...
class wedding_Product extends StatefulWidget {
  const wedding_Product({super.key});

  @override
  State<wedding_Product> createState() => _wedding_ProductState();
}

class _wedding_ProductState extends State<wedding_Product> {
  @override
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
            image: DecorationImage(
                fit: BoxFit.cover,
                image: AssetImage('assets/images/image 32.png'))),
        child: Center(
          child: Container(
            width: 282,
            height: 391,
