...
class TalentShoppreview extends StatefulWidget {
  const TalentShoppreview({super.key});

  @override
  State<TalentShoppreview> createState() => _TalentShoppreviewState();
}

class _TalentShoppreviewState extends State<TalentShoppreview> {
                  ...
                  Container(
                    ...
                    decoration: ShapeDecoration(
                      image: DecorationImage(
                        image:
                            AssetImage("assets/images/talentshowpreview.png"),
                        fit: BoxFit.cover,
                      ),
                      shape: RoundedRectangleBorder(
