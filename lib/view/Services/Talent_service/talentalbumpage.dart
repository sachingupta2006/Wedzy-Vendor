...
class Talentalbumpage extends StatefulWidget {
  const Talentalbumpage({super.key});

  @override
  State<Talentalbumpage> createState() => _TalentalbumpageState();
}

class _TalentalbumpageState extends State<Talentalbumpage> {
  @override
