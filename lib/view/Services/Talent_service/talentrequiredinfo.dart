...
class TalentRequiredInfo extends StatefulWidget {
  const TalentRequiredInfo({super.key});

  @override
  State<TalentRequiredInfo> createState() => _TalentRequiredInfoState();
}

class _TalentRequiredInfoState extends State<TalentRequiredInfo> {
  @override
