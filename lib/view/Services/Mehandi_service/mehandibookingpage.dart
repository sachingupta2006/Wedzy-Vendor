...
class Mehandibookingspage extends StatefulWidget {
  const Mehandibookingspage({super.key});

  @override
  State<Mehandibookingspage> createState() => _MehandibookingspageState();
}

class _MehandibookingspageState extends State<Mehandibookingspage> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Get.toNamed('/mehandiaddeventform');
                  },
                  child: CircleAvatar(
                      radius: 21.w,
                      backgroundColor: AppColors.buttoncolour,
            ...
            CustomButton(
                text: "Next",
                onTap: () {
                  Get.toNamed('/mehandibookingdone');
                }),
            sizedBoxHeight(40.h),
          ],
        ),
