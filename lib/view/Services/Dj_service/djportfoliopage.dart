...
class Djportfoliopage extends StatefulWidget {
  const Djportfoliopage({super.key});

  @override
  State<Djportfoliopage> createState() => _DjportfoliopageState();
}

class _DjportfoliopageState extends State<Djportfoliopage> {
  @override
