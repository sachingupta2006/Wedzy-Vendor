...
class Djalbumpage extends StatefulWidget {
  const Djalbumpage({super.key});

  @override
  State<Djalbumpage> createState() => _DjalbumpageState();
}

class _DjalbumpageState extends State<Djalbumpage> {
  @override
