...
class Cakebookingdone extends StatefulWidget {
  const Cakebookingdone({super.key});

  @override
  State<Cakebookingdone> createState() => _CakebookingdoneState();
}

class _CakebookingdoneState extends State<Cakebookingdone> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            CustomButton(
                text: "Preview",
                onTap: () {
                  Get.toNamed('/cakeshoppreviewpage');
                }),
            sizedBoxHeight(40.h),
          ],
        ),
