...
class CakeShoppreview extends StatefulWidget {
  const CakeShoppreview({super.key});

  @override
  State<CakeShoppreview> createState() => _CakeShoppreviewState();
}

class _CakeShoppreviewState extends State<CakeShoppreview> {
                  ...
                  Container(
                    ...
                    decoration: ShapeDecoration(
                      image: DecorationImage(
                        image: AssetImage("assets/images/cakepreview.png"),
                        fit: BoxFit.cover,
                      ),
                      shape: RoundedRectangleBorder(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      SvgPicture.asset(
                                          "assets/images/cakepreview1.svg"),
                                      sizedBoxWidth(5.w),
                                      Text(
                                        'Specialty -',
                                        style: TextStyle(
                                  ...
                                  Row(
                                    children: [
                                      SvgPicture.asset(
                                          "assets/images/cakepreview2.svg"),
                                      sizedBoxWidth(5.w),
                                      Text(
                                        'Flavors -',
                                        style: TextStyle(
