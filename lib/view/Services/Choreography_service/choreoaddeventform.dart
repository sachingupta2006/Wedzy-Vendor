...
class Choreoaddeventform extends StatefulWidget {
  const Choreoaddeventform({super.key});

  @override
  State<Choreoaddeventform> createState() => _ChoreoaddeventformState();
}

class _ChoreoaddeventformState extends State<Choreoaddeventform> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarDynamic(
          titleTxt: "Add Event", preferredSize: Size.fromHeight(50)),
