...
class Choreopackagespage extends StatefulWidget {
  const Choreopackagespage({
    Key? key,
  }) : super(key: key);
  @override
  State<Choreopackagespage> createState() => _ChoreopackagespageState();
}

class _ChoreopackagespageState extends State<Choreopackagespage> {
  bool chaat = false;
  bool live = false;
  bool cuisine = false;
      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            sizedBoxHeight(25.h),
            Text(
              '2. Tell us about your packages and pricing',
              style: TextStyle(
                color: Color(0xFF373434),
                fontSize: 15.sp,
                fontFamily: 'AvenirNextCyr',
