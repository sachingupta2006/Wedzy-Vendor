...
class Makeupbookingspage extends StatefulWidget {
  const Makeupbookingspage({super.key});

  @override
  State<Makeupbookingspage> createState() => _MakeupbookingspageState();
}

class _MakeupbookingspageState extends State<Makeupbookingspage> {
  ...
  Widget build(BuildContext context) {
    final Widget calendar = _getAppointmentEditorCalendar(calendarController);
    return Scaffold(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Get.toNamed('/makeupaddeventform');
                  },
                  child: CircleAvatar(
                      radius: 21.w,
                      backgroundColor: AppColors.buttoncolour,
