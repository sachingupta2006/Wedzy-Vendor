...
class Makeupbookingdone extends StatefulWidget {
  const Makeupbookingdone({super.key});

  @override
  State<Makeupbookingdone> createState() => _MakeupbookingdoneState();
}

class _MakeupbookingdoneState extends State<Makeupbookingdone> {
  @override
