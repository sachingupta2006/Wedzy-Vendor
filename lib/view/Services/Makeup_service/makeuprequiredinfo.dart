...
class MakeupRequiredInfo extends StatefulWidget {
  const MakeupRequiredInfo({super.key});

  @override
  State<MakeupRequiredInfo> createState() => _MakeupRequiredInfoState();
}

class _MakeupRequiredInfoState extends State<MakeupRequiredInfo> {
  @override
