...
class Makeupalbumpage extends StatefulWidget {
  const Makeupalbumpage({super.key});

  @override
  State<Makeupalbumpage> createState() => _MakeupalbumpageState();
}

class _MakeupalbumpageState extends State<Makeupalbumpage> {
  @override
