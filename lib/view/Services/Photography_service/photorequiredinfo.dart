...
class PhotoRequiredInfo extends StatefulWidget {
  const PhotoRequiredInfo({super.key});

  @override
  State<PhotoRequiredInfo> createState() => _PhotoRequiredInfoState();
}

class _PhotoRequiredInfoState extends State<PhotoRequiredInfo> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            CustomButton(
                text: "Next",
                onTap: () {
                  Get.toNamed('/photoportfoliopage');
                }),
            sizedBoxHeight(30.h),
          ],
        ),
