...
class VenueRequiredInfo extends StatefulWidget {
  const VenueRequiredInfo({super.key});

  @override
  State<VenueRequiredInfo> createState() => _VenueRequiredInfoState();
}

class _VenueRequiredInfoState extends State<VenueRequiredInfo> {
  @override
