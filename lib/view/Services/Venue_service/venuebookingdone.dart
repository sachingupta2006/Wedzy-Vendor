...
class Venuebookingdone extends StatefulWidget {
  const Venuebookingdone({super.key});

  @override
  State<Venuebookingdone> createState() => _VenuebookingdoneState();
}

class _VenuebookingdoneState extends State<Venuebookingdone> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            CustomButton(text: "Preview", onTap: () {
              Get.toNamed('/venueshopdetailpreview');
            }),
            sizedBoxHeight(40.h),
          ],
        ),
