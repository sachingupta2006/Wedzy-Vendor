...
class DecorandCateringpackagespage extends StatefulWidget {
  const DecorandCateringpackagespage({
    Key? key,
  }) : super(key: key);
  @override
  State<DecorandCateringpackagespage> createState() =>
      _DecorandCateringpackagespageState();
}

class _DecorandCateringpackagespageState
    extends State<DecorandCateringpackagespage> {
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                sizedBoxHeight(8.h),
                Text(
                  '- Tent or Marquee: Optional provision for \n shading or protection against weather\n conditions \n- Seating arrangements: Chairs, benches,\n or a combination\n- Decorations: Proper decorations of the \n Stage, and entire wedding Entrance \n setup, lights, lanterns, or other lighting \n options to enhance the ambiance.\n- Meals: Customized catering options for \n Dinner Buffet\n- Beverage Service: Non-alcoholic drinks \n throughout the day\n- Event Coordinator: Assistance with \n planning and coordination of the outdoor \n wedding',
                  style: TextStyle(
                    color: Color(0xFF373434),
                    fontSize: 15.sp,
                    fontFamily: 'AvenirNextCyr',
            ...
            Column(
              ...
              children: [
                ...
                sizedBoxHeight(8.h),
                Text(
                  '- Exclusive use of the big lawn for the \n entire day\n- Tent or Marquee: Optional provision for \n shading or protection against weather \n conditions\n- Seating arrangements: Chairs, benches, \n or a combination\n- Decorations: Proper decorations of the \n Stage, And entire wedding Entrance \n setup. \n- Meals: Customized catering options \n for breakfast, lunch, and dinner\n- Beverage Service: Non-alcoholic drinks \n throughout the day\n- Event Coordinator: Assistance with \n planning and coordination of the \n outdoor wedding ',
                  style: TextStyle(
                    color: Color(0xFF373434),
                    fontSize: 15.sp,
                    fontFamily: 'AvenirNextCyr',
            ...
            Column(
              ...
              children: [
                ...
                sizedBoxHeight(8.h),
                Text(
                  '- Exclusive use of the big lawn for a set \n no. of hours',
                  style: TextStyle(
                    color: Color(0xFF373434),
                    fontSize: 15.sp,
                    fontFamily: 'AvenirNextCyr',
